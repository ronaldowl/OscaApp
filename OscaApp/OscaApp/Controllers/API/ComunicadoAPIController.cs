...
namespace OscaAPI.Controllers
{
    ...
    public class ComunicadoAPIController : Controller
    {
        private readonly IComunicadoData serviceData;
        

        public ComunicadoAPIController(ContexDataService db)
        {
            this.serviceData = new ComunicadoData(db);          
        }    
